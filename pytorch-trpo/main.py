...
parser.add_argument('--batch-size', type=int, default=10000, metavar='N',
                    help='random seed (default: 1)')
parser.add_argument('--training-steps', type=int, default=500000, metavar='N',
                    help='random seed (default: 1)')
...
import sys
rewards_file = '../data/total_rewards_TRPO-'
f = open(rewards_file + str(args.training_steps) + '.txt', "a")
